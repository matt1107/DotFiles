...
-- {{{ Personal keybindings
    ...
    awful.key({ modkey, "Shift" }, "Return", function() awful.util.spawn("dolphin") end,
    ...
    awful.key({ modkey }, "n", function() awful.util.spawn("kate") end,
        { description = "launch kate", group = "Applications" }),
    ...
    awful.key({ modkey }, "e", function() awful.util.spawn("emacs") end,
        { description = "launch Visual Studio", group = "Applications" }),
    awful.key({ modkey }, "g", function() awful.util.spawn("godot-mono") end,
        { description = "launch Visual Studio", group = "Applications" }),
    awful.key({ modkey }, "v", function() awful.util.spawn("blender") end,
        { description = "launch Visual Studio", group = "Applications" }),
    awful.key({ modkey }, "m", function() awful.util.spawn("trenchbroom") end,
        { description = "trenchbroom", group = "Applications" }),
