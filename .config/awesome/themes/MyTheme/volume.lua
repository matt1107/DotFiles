...
local utils = require("themes.MyTheme.utils")
...
local widget_types = {
    icon_and_text = require("themes.MyTheme.widgets.icon-and-text-widget"),
    icon = require("themes.MyTheme.widgets.icon-widget"),
    arc = require("themes.MyTheme.widgets.arc-widget"),
    horizontal_bar = require("themes.MyTheme.widgets.horizontal-bar-widget"),
    vertical_bar = require("themes.MyTheme.widgets.vertical-bar-widget")
}
local volume = {}
